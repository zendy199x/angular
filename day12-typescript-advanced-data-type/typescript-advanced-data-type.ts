...
function listenCheck(port: StringOrNumber) {
    if (typeof port == 'string') {
        port = parseInt(port, 10)
    }
    // do something with port
...
type UserEntityDictionary = Dictionary<StringOrNumber>;
type UserEntityObjectDictionary = ObjectDictionary<string | number>;

const entity1: UserEntityDictionary = {
    foo: 123,
    bar: 123,
}

const entity2: UserEntityObjectDictionary = {
    foo: '123',
    bar: 123,
}
